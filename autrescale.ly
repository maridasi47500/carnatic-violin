...
\header {
  title = "Glissando lent sur toute la gamme"
  subtitle = "Avec le même doigt par note, sur une corde/2 cordes, en aller-retour"
...
violin = \relative d' {
  ...
  \markup { \bold "Glissando lent sur la gamme de Ré majeur (2 notes par mesure)" }
